<div
  class="air__card relative rounded-t-xl rounded-b-xl bg-white shadow-md pb-5 hover:-translate-y-5 hover:shadow-xl duration-150 cursor-pointer"
>
  <div
    class="air__card__header rounded-t-xl relative h-20 bg-gradient-to-r from-purple-400 to-blue"
  >
    <img
      src="/images/nikhil-mitra-gssCjrDR5Y4-unsplash.jpg"
      alt="airport"
      class="h-full w-full object-cover opacity-50 rounded-t-xl"
    />
    ...
    <h3 class="font-bold z-10 text-white text-xl absolute right-3 bottom-1">
      اسپانسر
    </h3>
  </div>
  <div class="air__body">
    ...
    <div class="flex justify-around items-center mt-5">
      <div class="flex flex-col gap-3 text-center">
        <span>نوع پرواز</span>
        <span class="text-xl font-bold">سیستمی</span>
      </div>
      <div class="flex flex-col gap-3 text-center">
        <span>کلاس</span>
        <span class="text-xl font-bold">اکونومی</span>
      </div>
    </div>
