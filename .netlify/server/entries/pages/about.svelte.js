...
const About = (0, import_index_ab1d6d64.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"flex items-center gap-5 mb-32"}"><div class="${"w-1/2"}"><h3 class="${"text-3xl mb-5 text-black font-bold"}">\u0686\u0645\u062F\u0627\u0646 \u0633\u0641\u0631 \u0686\u06CC\u0633\u062A\u061F</h3>
  ...
  <div class="${"w-1/2"}"><img class="${"w-full rounded-3xl"}" src="${"/images/phil-mosley-wOK2f2stPDg-unsplash.jpg"}"></div></div>
...
${(0, import_index_ab1d6d64.v)(import_Select_833eff02.S, "Select").$$render($$result, {}, {}, {})}`;
});
