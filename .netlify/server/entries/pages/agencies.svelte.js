...
const AgencyCard = (0, import_index_ab1d6d64.c)(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"agency__card"}"><img class="${"agency__card__image"}" src="${"/images/phil-mosley-wOK2f2stPDg-unsplash.jpg"}">
  <div class="${"agency__card__body"}"><h2 class="${"agency__card__title"}">\u0622\u0698\u0627\u0646\u0633 \u0634\u0645\u0627\u0631\u0647 1</h2>
    <p class="${"agency__card__description"}">\u062C\u0632\u0626\u06CC\u0627\u062A \u0622\u0698\u0627\u0646\u0633 \u0634\u0645\u0627\u0631\u0647 \u062F\u0648</p>
...
const Agencies = (0, import_index_ab1d6d64.c)(($$result, $$props, $$bindings, slots) => {
  return `<h1 class="${"page__title"}">\u0622\u0698\u0627\u0646\u0633 \u0647\u0627</h1>
    <div class="${"grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10"}">${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}
    ${(0, import_index_ab1d6d64.v)(AgencyCard, "AgencyCard").$$render($$result, {}, {}, {})}</div>`;
});
