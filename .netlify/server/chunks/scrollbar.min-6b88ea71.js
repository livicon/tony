...
const Swiper = (0, import_index_ab1d6d64.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_ab1d6d64.k)($$props, ["class", "swiper"]);
  const dispatch = (0, import_index_ab1d6d64.f)();
  ...
  const setVirtualData = (data) => {
    virtualData = data;
    (0, import_index_ab1d6d64.t)().then(() => {
  ...
  (0, import_index_ab1d6d64.s)("swiper", swiperInstance);
  ...
  return `<div${(0, import_index_ab1d6d64.b)([
    {
      class: (0, import_index_ab1d6d64.l)(uniqueClasses(`${containerClasses}${className ? ` ${className}` : ""}`))
    },
    (0, import_index_ab1d6d64.e)(restProps)
  ], {})}${(0, import_index_ab1d6d64.h)("this", swiperEl, 0)}>${slots["container-start"] ? slots["container-start"]({ virtualData }) : ``}
  ${needsNavigation(swiperParams) ? `<div class="${"swiper-button-prev"}"${(0, import_index_ab1d6d64.h)("this", prevEl, 0)}></div>
    <div class="${"swiper-button-next"}"${(0, import_index_ab1d6d64.h)("this", nextEl, 0)}></div>` : ``}
  ${needsScrollbar(swiperParams) ? `<div class="${"swiper-scrollbar"}"${(0, import_index_ab1d6d64.h)("this", scrollbarEl, 0)}></div>` : ``}
  ${needsPagination(swiperParams) ? `<div class="${"swiper-pagination"}"${(0, import_index_ab1d6d64.h)("this", paginationEl, 0)}></div>` : ``}
...
const Swiper_slide = (0, import_index_ab1d6d64.c)(($$result, $$props, $$bindings, slots) => {
  let slideData;
  let $$restProps = (0, import_index_ab1d6d64.k)($$props, ["zoom", "virtualIndex", "class"]);
  let { zoom = void 0 } = $$props;
  let { virtualIndex = void 0 } = $$props;
  let { class: className = void 0 } = $$props;
  let slideEl = null;
  let slideClasses = "swiper-slide";
  let swiper = (0, import_index_ab1d6d64.g)("swiper");
  ...
  return `<div${(0, import_index_ab1d6d64.b)([
    {
      class: (0, import_index_ab1d6d64.l)(uniqueClasses(`${slideClasses}${className ? ` ${className}` : ""}`))
    },
    {
      "data-swiper-slide-index": (0, import_index_ab1d6d64.l)(virtualIndex)
    },
    (0, import_index_ab1d6d64.e)($$restProps)
  ], {})}${(0, import_index_ab1d6d64.h)("this", slideEl, 0)}>${zoom ? `<div class="${"swiper-zoom-container"}"${(0, import_index_ab1d6d64.h)("data-swiper-zoom", typeof zoom === "number" ? zoom : void 0, 0)}>${slots.default ? slots.default({ data: slideData }) : ``}</div>` : `${slots.default ? slots.default({ data: slideData }) : ``}`}</div>`;
});
var swiper_min = "";
var pagination_min = "";
var navigation_min = "";
